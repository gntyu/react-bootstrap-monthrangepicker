...
var MonthRangePicker = function (_Component) {
  inherits(MonthRangePicker, _Component);

  function MonthRangePicker(props) {
    classCallCheck(this, MonthRangePicker);

    var _this = possibleConstructorReturn(this, (MonthRangePicker.__proto__ || Object.getPrototypeOf(MonthRangePicker)).call(this, props));
